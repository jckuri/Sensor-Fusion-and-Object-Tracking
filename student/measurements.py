...
class Sensor:
    ...
    def in_fov(self, x):
        ...
        within_fov = alpha > self.fov[0] and alpha < self.fov[1]
        #print('alpha:', alpha, type(alpha), 'within_fov:', within_fov, type(within_fov))
        return within_fov
...
class Measurement:
    ...
    def __init__(self, num_frame, z, sensor):
        print(f'New measurement: num_frame={num_frame}, sensor.name={sensor.name}\n{z}')
